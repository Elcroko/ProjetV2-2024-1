    ...
    while (1) {
        ...
        switch (choix) {
            case 1: {
                ...
                myScanf(prenom, LONGUEUR_MAX_NOM, "Entrez le prénom de l'athlète: ");
                ...
                retVal = scanf("%s", epreuve);
                printf("Entrez le temps (h m s ms): ");
                retVal = scanf("%d %d %d %d", &temps_h, &temps_m, &temps_s, &temps_ms);
